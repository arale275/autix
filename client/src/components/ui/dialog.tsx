// client/src/components/ui/dialog.tsx - תיקון הרקע השקוף
"use client";
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          // ✅ החלפתי bg-background ב-bg-white מפורש + הוספתי border לבן
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "text-lg leading-none font-semibold text-gray-900",
        className
      )}
      {...props}
    />
