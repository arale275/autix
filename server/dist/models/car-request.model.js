...
exports.CarRequestModel = void 0;
...
class CarRequestModel {
    ...
    `;
        const result = await database_config_1.default.query(query, [buyerId]);
        return result.rows;
    }
    ...
    static async getActiveCount() {
        ...
        const result = await database_config_1.default.query(query);
        return parseInt(result.rows[0].count);
    }
}
exports.CarRequestModel = CarRequestModel;
