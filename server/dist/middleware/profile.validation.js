...
exports.validateProfileFilters = exports.validateUserType = exports.validateUpdateBuyerProfile = exports.validateUpdateDealerProfile = exports.validateUpdateUserProfile = void 0;
...
const validateUpdateDealerProfile = (req, res, next) => {
    const { business_name, license_number, address, city, description } = req.body;
    const errors = [];
    // בדיקת שם עסק
    ...
    if (license_number !== undefined && license_number !== null) {
        ...
        else if (license_number.trim().length > 0 &&
    ...
    // ניקוי נתונים
    if (business_name)
        req.body.business_name = business_name.trim();
    if (license_number)
...
exports.validateUpdateDealerProfile = validateUpdateDealerProfile;
const validateUpdateBuyerProfile = (req, res, next) => {
    ...
    if (preferences !== undefined && preferences !== null) {
        if (typeof preferences !== "object") {
            ...
            // בדיקת תמסורת מועדפת
            if (preferences.preferred_transmission &&
                !["manual", "automatic", "both"].includes(preferences.preferred_transmission)) {
                errors.push("תמסורת מועדפת לא תקינה (manual, automatic, both)");
            }
            // בדיקת קילומטרז' מקסימלי
            if (preferences.max_mileage !== undefined &&
                preferences.max_mileage !== null) {
                if (isNaN(Number(preferences.max_mileage)) ||
            ...
            if (preferences.min_year !== undefined && preferences.min_year !== null) {
                ...
                if (isNaN(Number(preferences.min_year)) ||
            ...
            // בדיקת דרישות נוספות
            if (preferences.other_requirements !== undefined &&
...
exports.validateUpdateBuyerProfile = validateUpdateBuyerProfile;
...
const validateProfileFilters = (req, res, next) => {
    ...
    if (verified_only && !["true", "false"].includes(verified_only)) {
...
exports.validateProfileFilters = validateProfileFilters;
