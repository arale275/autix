...
exports.validateCarRequestId = exports.validateCarRequestFilters = exports.validateUpdateCarRequest = exports.validateCreateCarRequest = void 0;
...
exports.validateCreateCarRequest = validateCreateCarRequest;
const validateUpdateCarRequest = (req, res, next) => {
    const { make, model, year_min, year_max, price_max, requirements, status } = req.body;
    const errors = [];
    // בדיקת שנים
    if (year_min &&
        (year_min < 1900 || year_min > new Date().getFullYear() + 1)) {
...
exports.validateUpdateCarRequest = validateUpdateCarRequest;
const validateCarRequestFilters = (req, res, next) => {
...
exports.validateCarRequestFilters = validateCarRequestFilters;
const validateCarRequestId = (req, res, next) => {
    const { id } = req.params;
...
exports.validateCarRequestId = validateCarRequestId;
